...
public sealed class TanStackGenerator : IIncrementalGenerator
{
    ...
    {
        var escapedTs = tsCode.Replace("*/", "*\\/");

        return $$"""
            // <auto-generated>
            // This code was generated by Moj.TanStack.SourceGenerator
            // Do not modify this file directly.
            // Generated from: {{classSymbol.ToDisplayString()}}
            // </auto-generated>

            namespace {{classSymbol.ContainingNamespace.ToDisplayString()}}.Generated
            {
                /// <summary>
                /// Generated TypeScript code for {{classSymbol.Name}}
                /// </summary>
                public static partial class {{classSymbol.Name}}Ts
                {
                    /// <summary>
                    /// The file name for the generated TypeScript
                    /// </summary>
                    public const string FileName = "{{fileName}}.ts";
            ...
            */
            """;
                    ...
                    /// <summary>
                    /// Gets the raw TypeScript without wrapper comments
                    /// </summary>
                    public static string GetTypeScript() => @"{{escapedTs.Replace("\"", "\"\"")}}";
                }
            }
            """;
    }
